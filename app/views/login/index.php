...
<head>
    ...
    <!-- Font-->
    <link rel="stylesheet" type="text/css" href="<?= BASEURL; ?>/css/sourcesanspro-font.css">
    <!-- Main Style Css -->
...
<body class="form-v8">
    <div class="page-content">
        <div class="form-v8-content">
            <div class="form-left">
                <img src="<?= BASEURL; ?>/img/form-v8.jpg" alt="form">
            </div>
            <div class="form-right">
                ...
                <form class="form-detail" action="<?= BASEURL; ?>/login/daftar" method="post">
                    <div class="tabcontent" id="sign-up">
                        ...
                        <div class="form-row">
                            <label class="form-row-inner">
                                <input type="number" name="no_hp" id="no_hp" class="input-text" required>
                ...
                <form class="form-detail" action="<?= BASEURL; ?>/login/masuk" method="post">
