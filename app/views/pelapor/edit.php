                        ...
                        <form action="<?= BASEURL; ?>/pelapor/getedit" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 pr-1">
                                    <div class="form-group">
                                        <label>NIK</label>
                                        <input type="text" class="form-control" id="nik" name="nik" value="<?= $data['pelapor']['nik']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6 pl-1">
                                    <div class="form-group">
                                        <label>Nama Lengkap</label>
                                        <input type="text" class="form-control" id="nama" name="nama" value="<?= $data['pelapor']['nama']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tmp_lahir" name="tmp_lahir" value="<?= $data['pelapor']['tmp_lahir']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 pl-1">
                                    <div class="form-group">
                                        <label>Alamat</label>
                                        <input type="text" class="form-control" id="alamat" name="alamat" value="<?= $data['pelapor']['alamat']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-3 px-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" value="<?= $data['pelapor']['pekerjaan']; ?>">
                                    </div>
                                </div>
